...
#+latex_header: \bibliography{../bibliography/zoteroLibrary.bib}
#+EXCLUDE_TAGS: journal noexport

# * Acronym and Glossary                                      :ignore:noexport:
...
* Theory
  ...
  #+INCLUDE: "./theory/current_dft_chapter.org" :lines "2-"



* Fitting a titanium tight-binding model for defect modelling
  :PROPERTIES:
  :ALT_TITLE: Creating a tight-binding model for pure titanium
  :END:
  #+INCLUDE: "./titanium/ti_fitting.org" :lines "2-"


* Defect modelling in titanium using tight-binding and BOP

  #+INCLUDE: "./titanium/ti_dislocation_modelling.org" :lines "2-"


* Dislocation-carbon interactions in Fe
  #+INCLUDE: "./iron/atomistic_dislocation_carbon_migration_line-tension.org"



* Diffusion of carbon around hard core
