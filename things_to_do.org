...
** TODO Build force constant matrix for hcp 
...
*** Results
    ...
    - File and data: [[file:~/Documents/disl_gsurf/hcp_pris_screw/hcp_relaxed_pris_screw/gamma_surfaces/data/plot_hsbc_pkl.py][basal_energy_plotting]]
[[file:~/Documents/disl_gsurf/hcp_pris_screw/hcp_relaxed_pris_screw/gamma_surfaces/data/gamma_line_along_1-210_wrong_endpoints.png]] 
...
**** Introduction to Biased Potentials
     ...
     - This means we can express the free energy difference 
