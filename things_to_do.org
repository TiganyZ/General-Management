...
** TODO Could one see how to use Ising model SFEs and Fourier Interpolation?  
 - Maybe one can do this for the Prismatic stacking fault.
   ...
   - This means that one can have a stacking that is probably ABCD or
     something. Must investigate this further.    
...
** DONE Use python voronoi around a surface to find triangles through which dislocations will pass
