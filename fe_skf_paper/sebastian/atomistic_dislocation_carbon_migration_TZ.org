...
* Discussion
  ...
  # - Novel work to find out dislocation environment around both dislocation cores.
	...
	# The expected transition kink-shape may differ compared to that of DFT, with some dislocation
	# core positions possibly being situated closer to a split core position due to its lower
	# energy than the hard core, similar to EAM potentials cite:Itakura2012. 
