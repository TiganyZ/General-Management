...
\section{Results}
\label{sec:orgda7ac37}

\subsection{Peierls Potential}
\label{sec:orgb6bbf6a}
...
\includegraphics[width=\textwidth]{Images/easy-easy_transition_pathway_combined_dft_dTB_eam_line-tension_nopoints.png}
