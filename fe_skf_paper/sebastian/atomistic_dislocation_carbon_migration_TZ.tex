...
\section{Results}
\label{sec:org2b09e4c}

\subsection{Peierls Potential}
\label{sec:org1e0cf74}
...
\includegraphics[width=\textwidth]{Images/easy-easy_transition_pathway_combined_dTB_sdTB_DFT_EAM_dotted.png}
...
\includegraphics[width=0.9\textwidth]{Images/lineshape-all_redo.png}
...
\includegraphics[width=0.9\textwidth]{Images/kink-pair_formation_enthalpies_all.png}
