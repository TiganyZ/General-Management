...
\section{Results}
\label{sec:org16bf078}

\subsection{Peierls Potential}
\label{sec:org8711c30}
...
\includegraphics[width=\textwidth]{Images/easy-easy_transition_pathway_correct_gradient.png}
...
\begin{center}
\includegraphics[width=.9\linewidth]{Images/H_pathway_tol_1e-3.png}
\end{center}
...
\begin{center}
\includegraphics[width=.9\linewidth]{Images/img_comparison_of_kink_pair_energies_real_stress_prelim.png}
\end{center}

\begin{center}
\includegraphics[width=.9\linewidth]{Images/H_itakura_0.0_MPa.png}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{Images/H_itakura_0.0025_MPa.png}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{Images/H_itakura_0.005_MPa.png}
\end{center}

\begin{figure}[htbp]

\includegraphics[width=0.9\textwidth]{Images/img_comparison_of_kink_pair_energies_real_stress.png}
...
\begin{center}
\includegraphics[width=.9\linewidth]{Images/img_differeice_of_kink_pair_energies_real_stress.png}
\end{center}


\begin{center}
\includegraphics[width=.9\linewidth]{Images/img_comparison_of_kink_pair_energies.png}
\end{center}
