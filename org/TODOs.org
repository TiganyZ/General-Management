...
** WAITING Chat to Nigel about RR dates and organisation            :WAITING:
   SCHEDULED: <2021-09-02 Thu 13:15>
   - State "WAITING"    from "TODO"       [2021-08-10 Tue 16:55] \\
     Waiting for a response from Nigel
   :LOGBOOK:
   CLOCK: [2021-08-31 Tue 14:36]--[2021-08-31 Tue 14:48] =>  0:12
   CLOCK: [2021-08-31 Tue 10:17]--[2021-08-31 Tue 10:25] =>  0:08
   CLOCK: [2021-08-09 Mon 13:55]--[2021-08-09 Mon 13:55] =>  0:00
   :END:
 [2021-08-09 Mon 13:55]
** DONE Book Flights to Helsinki
   SCHEDULED: <2021-08-16 Mon 14:00>
   - State "DONE"       from "WAITING"    [2021-08-31 Tue 15:56]
   - State "WAITING"    from "TODO"       [2021-08-26 Thu 09:11] \\
     Put on hold until early September <2021-09-06 Mon>. Perhaps look at flights on the
     sunday instead.
   :LOGBOOK:
   CLOCK: [2021-08-26 Thu 09:09]--[2021-08-26 Thu 09:12] =>  0:03
...
* TODO WRITE! [1/9]
  SCHEDULED: <2021-08-27 Fri 09:00 +1d>
  :PROPERTIES:
  :STYLE:    habit
  :REPEAT_TO_STATE: TODO
  :WILD_NOTIFIER_NOTIFY_BEFORE: 60 30 15 5
  :LAST_REPEAT: [2021-09-02 Thu 16:53]
  :COOKIE_DATA: todo
  :END:
  - State "DONE"       from "TODO"       [2021-09-02 Thu 16:53]
  - State "DONE"       from "TODO"       [2021-08-25 Wed 17:38]
  - State "DONE"       from "TODO"       [2021-08-24 Tue 18:00]
  :LOGBOOK:
  CLOCK: [2021-09-01 Wed 14:48]--[2021-09-01 Wed 14:49] =>  0:01
  CLOCK: [2021-08-31 Tue 15:25]--[2021-08-31 Tue 15:34] =>  0:09
  CLOCK: [2021-08-25 Wed 17:38]--[2021-08-25 Wed 17:38] =>  0:00
  CLOCK: [2021-08-25 Wed 16:27]--[2021-08-25 Wed 16:52] =>  0:25
  CLOCK: [2021-08-25 Wed 11:14]--[2021-08-25 Wed 11:39] =>  0:25
  CLOCK: [2021-08-25 Wed 10:19]--[2021-08-25 Wed 10:44] =>  0:25
  CLOCK: [2021-08-25 Wed 09:49]--[2021-08-25 Wed 10:14] =>  0:25
...
** Where to find
  ...
  [[file:~/Documents/docs/Management/literature_and_notes/notes_and_literature.org]]

  For DFT, use the chapter
 [[file:~/Documents/docs/Management/chapters/current_dft_chapter.org]]


  We have dislocation modelling in
  [[file:~/Documents/docs/Management/chapters/ti_dislocation_modelling.org]]

  Thesis template can be found here
  [[file:~/Downloads/phd_thesis_compiler]]
** DONE Org Thesis setup
   :LOGBOOK:
   CLOCK: [2021-09-01 Wed 14:49]--[2021-09-01 Wed 15:12] =>  0:23
   :END:
** TODO Think of the general focus of the work
   In the modelling of these defects, how is it useful?

   What can we improve upon, what types of models can we make?

** TODO Matplotlib / gnuplot style choices?
...
* TODO Hydrogen-titanium fitting [8/11]
  :PROPERTIES:
  :COOKIE_DATA: todo
  :END:

  :LOGBOOK:
  CLOCK: [2021-09-01 Wed 11:12]--[2021-09-01 Wed 11:31] =>  0:19
  CLOCK: [2021-08-31 Tue 16:30]--[2021-08-31 Tue 16:56] =>  0:26
  CLOCK: [2021-08-31 Tue 15:57]--[2021-08-31 Tue 16:22] =>  0:25
  CLOCK: [2021-08-31 Tue 11:03]--[2021-08-31 Tue 11:11] =>  0:08
  CLOCK: [2021-08-25 Wed 17:07]--[2021-08-25 Wed 17:32] =>  0:25
  CLOCK: [2021-08-25 Wed 15:16]--[2021-08-25 Wed 15:41] =>  0:25
  CLOCK: [2021-08-25 Wed 13:56]--[2021-08-25 Wed 14:21] =>  0:25
  CLOCK: [2021-08-25 Wed 13:22]--[2021-08-25 Wed 13:32] =>  0:10
...
** DONE Put in 2x2 data from sasha
   :LOGBOOK:
   CLOCK: [2021-08-31 Tue 15:34]--[2021-08-31 Tue 15:43] =>  0:09
   CLOCK: [2021-08-31 Tue 15:22]--[2021-08-31 Tue 15:25] =>  0:03
   CLOCK: [2021-08-31 Tue 14:23]--[2021-08-31 Tue 14:36] =>  0:13
   CLOCK: [2021-08-31 Tue 12:12]--[2021-08-31 Tue 12:37] =>  0:25
   CLOCK: [2021-08-31 Tue 11:33]--[2021-08-31 Tue 11:58] =>  0:25
   CLOCK: [2021-08-31 Tue 11:11]--[2021-08-31 Tue 11:28] =>  0:17
   :END:

   I should probably put in the data. This will make it much slower,
   but for how much gain, given that the amplitude is reasonable, it
   is just the energy gaps. Perhaps one can just add in the energy gap
   difference as a fixed difference into the objective function, but
   this relies on the assumption that regardless of the parameters
   used, there will be the same static difference, which is likely an
   erroneous assumption.

** TODO Put in bandwidth monitor for TiH2 fluorite phase


   _GGA DFT_
   - With coloured bands
   [[file:~/Documents/tih/tih2/fluorite/bands/r-fluorite_ec_2021-06-16--13-58-39/bnds.flrt]]

   _TBE example_
   - No coloured bands
   [[file:~/Documents/tih/tih2/fitting/check_combined_fitting/r-tih2_obj_2021-08-31--16-34-49/bnds.flrt]]


** TODO Fitting of TiH with TiO2
   :LOGBOOK:
   CLOCK: [2021-09-01 Wed 14:47]--[2021-09-01 Wed 14:48] =>  0:01
   CLOCK: [2021-09-01 Wed 11:36]--[2021-09-01 Wed 12:01] =>  0:25
   ...
   - <2021-09-01 Wed 11:23>
     - Putting in the bandwidth monitoring seems to be helping the bands
       somewhat, at the cost of the elastic properties of the TiH2
       phase.
     - We will see what happens as the fitting continues.
     - The band gaps of the TiO2 phases seems fine.
     - Anatase still is lower energy than Rutile but we will have to
       live with that.

   - <2021-08-31 Tue 12:29>
     - Bands for the TiO2 phases seems okay, but for the TiH2
       fluorite phase, they are quite off it seems...
     - Revise the fitting for TiH.
   - <2021-08-31 Tue 12:19>
     - Binary works for older version found in ti:/home/tigany/bucket/lm/b/gcc-opt-mpi
   - <2021-08-31 Tue 12:14>
     - Seems like binary ti:/home/tigany/lm/b/gcc_opt_2021-08-12  fails for all the tio2 calcluations: rutile,
       anatase and fluorite.
     - But seems to get the gaps right?
     - Get seg faults when reading the syml file

   - <2021-08-31 Tue 11:00>
     - Put in the new data of sasha for 2x2
...
* TODO EFA [3/9]
  SCHEDULED: <2021-08-26 Thu 09:00>
  :PROPERTIES:
  :COOKIE_DATA: todo
  :END:
  <2021-08-06 Fri>--<2021-09-03 Fri>

** TODO Import from CSV the things necessary for the database
   SCHEDULED: <2021-08-31 Tue 10:00>
   :LOGBOOK:
   CLOCK: [2021-08-31 Tue 10:34]--[2021-08-31 Tue 10:42] =>  0:08
   CLOCK: [2021-08-26 Thu 16:06]--[2021-08-26 Thu 16:31] =>  0:25
   CLOCK: [2021-08-26 Thu 15:33]--[2021-08-26 Thu 15:58] =>  0:25
   CLOCK: [2021-08-26 Thu 14:55]--[2021-08-26 Thu 15:20] =>  0:25
   CLOCK: [2021-08-26 Thu 14:31]--[2021-08-26 Thu 14:49] =>  0:18
   :END:
** TODO Hosting on amazon EC2, is it fine to handle a large postgreSQL database?
...
* DONE Chat with Nigel about RR Internship
  - State "DONE"       from "WAITING"    [2021-08-31 Tue 10:17]
...
* MEETING with Counsellor                                           :MEETING:
  SCHEDULED: <2021-09-02 Thu 17:00 ++7d>
  :PROPERTIES:
...
* DONE Email Aalto about dates and accommadation
  ...
  :END:
[2021-08-24 Tue 09:07]
* WAITING Accommodation in Derby                                    :WAITING:
  SCHEDULED: <2021-08-31 Tue>
  - State "WAITING"    from "TODO"       [2021-08-25 Wed 15:00] \\
    Waiting on response from student.com
  :LOGBOOK:
  CLOCK: [2021-08-25 Wed 14:34]--[2021-08-25 Wed 14:59] =>  0:25
  CLOCK: [2021-08-25 Wed 14:33]--[2021-08-25 Wed 14:33] =>  0:00
  :END:
  [2021-08-25 Wed 14:33]

  - Mickelover is a 20/25 min cycle away from Elton Rd
  - Can book studen accommodation, will just await a reply
  - Cathedral quarter seems like a good shout
* TODO Reply to Nigel
  :LOGBOOK:
  CLOCK: [2021-08-26 Thu 09:40]--[2021-08-26 Thu 10:05] =>  0:25
  CLOCK: [2021-08-26 Thu 09:16]--[2021-08-26 Thu 09:34] =>  0:18
  CLOCK: [2021-08-26 Thu 09:16]--[2021-08-26 Thu 09:16] =>  0:00
  :END:
[2021-08-26 Thu 09:16]
* TODO Contract for Rolls-Royce
  SCHEDULED: <2022-05-22 Sun> DEADLINE: <2022-05-22 Sun>
  :LOGBOOK:
  CLOCK: [2021-08-26 Thu 10:24]--[2021-08-26 Thu 12:04] =>  1:40
  :END:
  [2021-08-26 Thu 10:24]

  Date for one month prior to report
  <2022-04-22 Fri 09:00>
  - I must give an annual report by 22 May 2022.
