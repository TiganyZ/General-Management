...
\$\$\Big( 
   \(\sum\)\textsubscript{i} -\frac{1}{2} \(\nabla\)\textsubscript{i}\textsuperscript{2} 
\begin{itemize}
\item \frac{1}{2} \(\sum\)\textsubscript{i\(\sum\)}\textsubscript{j}    \frac{1}\{| \mathbf{r}\textsubscript{i} - \mathbf{r}\textsubscript{j} |\}
\item \(\sum\)\textsubscript{i\(\sum\)}\textsubscript{I} \frac{-Z_I}\{| \mathbf{r}\textsubscript{i} - \mathbf{R}\textsubscript{I} |\}
\end{itemize}
...
\$\$ T\textsubscript{\text{Nuclear}}(\mathbf{R}) \(\psi\)\textsubscript{\mathbf{R}}(\mathbf{r}) = \(\sum\)\textsubscript{I = 1}\textsuperscript{M} 
\begin{itemize}
\item \frac{1}\{2M\textsubscript{I}\}
\(\nabla\)\textsuperscript{2}\textsubscript{\mathbf{R}\textsubscript{I}} \(\psi\)\textsubscript{\mathbf{R}}(\mathbf{r})  \$\$
\end{itemize}


\$\$
T\textsubscript{\text{Electronic}}(\mathbf{r}) \(\psi\)\textsubscript{\mathbf{R}}(\mathbf{r}) = \(\sum\)\textsubscript{i = 1}\textsuperscript{M} 
\begin{itemize}
\item \frac{1}\{2m\textsubscript{i}\}
\(\nabla\)\textsuperscript{2}\textsubscript{\mathbf{r}\textsubscript{i}} \(\psi\)\textsubscript{\mathbf{R}}(\mathbf{r})
\end{itemize}
