...
\caption{\label{fig:Bond-integrals-with-multiplicative-polynomial-cutoffs.}Bond integrals with multiplicative polynomial cutoffs.}
\end{figure}
\begin{figure}[htb]
\centering
...
\caption{\label{fig:Bond-integrals-with-multiplicative-polynomial-cutoffs:-zoomed-in.}Bond integrals with multiplicative polynomial cutoffs: zoomed in.}
\end{figure}
