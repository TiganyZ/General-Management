...
\label{sec:org1492c6e}


\subsection{Quadrupolar Array}
\label{sec:org9872bbf}

\subsubsection{Methodology}
\label{sec:orgf2c19d3}
...
\label{sec:org375d16e}

\subsubsection{Methodology}
\label{sec:orgbf6cf1d}
...
\subsubsection{Peierls Stress}
\label{sec:orgfce311c}

\begin{enumerate}
\item yz strain (basal transformation)
\label{sec:org75db390}
...
\label{sec:org656251a}

\subsection{Quadrupolar Array}
\label{sec:org2c11c83}
...
\section{BOP}
\label{sec:orgb4ade8e}

\subsection{4 recursion levels}
\label{sec:orgad8dab0}
