...
\label{sec:orgbe99d29}


\subsection{Quadrupolar Array}
\label{sec:orgad53587}

\subsubsection{Methodology}
\label{sec:orgfdc5e98}
...
\label{sec:org6986cc3}

\subsubsection{Methodology}
\label{sec:org7ee7f66}
...
\subsubsection{Peierls Stress}
\label{sec:org0eda1db}

\begin{enumerate}
\item yz strain (basal transformation)
\label{sec:orgfcae13c}
...
\label{sec:org59f3cda}

\subsection{Quadrupolar Array}
\label{sec:orgc81148b}
...
\section{BOP}
\label{sec:orgeb04eef}

\subsection{4 recursion levels}
\label{sec:org45f4430}
