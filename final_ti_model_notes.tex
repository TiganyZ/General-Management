...
\label{sec:org2a12dc4}


\subsection{Quadrupolar Array}
\label{sec:orgc4ad0c7}

\subsubsection{Methodology}
\label{sec:orgf58d44b}
...
\label{sec:org778537b}

\subsubsection{Methodology}
\label{sec:org82eb8fb}
...
\subsubsection{Peierls Stress}
\label{sec:org11c3663}

\begin{enumerate}
\item yz strain (basal transformation)
\label{sec:org4f4f9c7}
...
of an opposite type. 
 ...
 \begin{table}	
\begin{tabular}{cccc}
    \small  O1 & O2 & O3 & O4 \\ \hline
    % \small Before relaxation ($\mathbf{b} = 1/3\langle 1 \bar{2} 1 0 \rangle$) &
\addheight{\includegraphics[width=0.165\textwidth]{Images/Ti_IP1-O_interaction/crop/Ti-O1_initial.png}}&
\addheight{\includegraphics[width=0.165\textwidth]{Images/Ti_IP1-O_interaction/crop/Ti-O2_initial.png}}&
\addheight{\includegraphics[width=0.165\textwidth]{Images/Ti_IP1-O_interaction/crop/Ti-O3_initial.png}}&
\addheight{\includegraphics[width=0.165\textwidth]{Images/Ti_IP1-O_interaction/crop/Ti-O4_initial.png}}\\

\addheight{\includegraphics[width=0.165\textwidth]{Images/Ti_IP1-O_interaction/crop/Ti-O1_final.png}}&
\addheight{\includegraphics[width=0.165\textwidth]{Images/Ti_IP1-O_interaction/crop/Ti-O2_final.png}}&
\addheight{\includegraphics[width=0.165\textwidth]{Images/Ti_IP1-O_interaction/crop/Ti-O3_final.png}}&
\addheight{\includegraphics[width=0.165\textwidth]{Images/Ti_IP1-O_interaction/crop/Ti-O4_final.png}}\\
