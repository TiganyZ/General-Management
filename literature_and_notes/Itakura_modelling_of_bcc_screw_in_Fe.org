...
** Necessary Calculations
    ...
    3) Kink formation enthalpy *with* and *without*
       ...
       - The reduction in the enthalpies is $\Delta E_K = E_K - E_{KH}
         = 110 meV$
    4) Frequency prefactor $f_{kp}$ is determined by *comparing* the
       *velocity* of the pure scew segment in $\alpha$-Fe calculated
       *from the KMC* and the *experimentally determined velocity*.
    5) Solution energies of carbon in different positions around the
       dislocation line
       - To account for changes in the solution enthalpy of the solute
         as a kink sweeps past.
    6) The change in these solution energies with applied stress to
       find $E_t(\sigma)$.
