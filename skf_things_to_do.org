...
** DONE Core reconstruction (ECC -> HCC) by C
...
* DONE Current Calculations
** DONE Core Reconstruction of C with easy core to hard core.
...
** DONE Details of the context of the project.
