...
*** Analysis with Final Ti model. 
   ...
   \[
    ...
    eV/\AA^3 , $\alpha = 0$ and $\gamma_{\text{p}} = 98.95340236$ mJm^{-2} $=
    1.6021766208*10^(-19) * 10^{-3} * 10^20 * 98.95340236 = 1.58540827809$
    eV/\AA^3, $a = 2.955577 \AA$ we have the equilibrium dissociation
    distance in the prismatic plane as $d_{\text{p}}^{\text{eq}} = 0.05845
    \AA$, which seems a little close looking at the results... 
