...
#+ATTR_REVEAL: :frag fade-in
#+ATTR_HTML: :width 70% :style position:absolute;top:105px;left:450px;z_index:2;
[[file:~/Documents/docs/Management/Images/enthalpy_and_vibrational_Rydberg_alternate_lda_thick.png]]
...
** Pure Ti: Next steps
- Analyse embedding calculations
- Calculate Peierls barriers. 

* Defect Clusters 

- Increase in oxygen content in Ti-7wt%Al causes more $\alpha_2$ precipitates
  upon annealing (Felicity's results). 
- Oxygen acting as a defactant might stabilise defect complexes (Ti_v + $n$O).
- This can cause more defects resulting in an increased number of precipitates due to more nucleation sites.
- First starting out with pure Ti and $\alpha_2$. Extension to Ti-7wt%Al may
  be possible. 
...
#+NAME: Ti3al VTi
#+ATTR_HTML: :width 70% :style position:relative;top:0px;left:0px;z_index:1;
[[file:~/Documents/docs/Management/Images/ti3al_vti_o.png]]
...
- Extend to Ti-7wt%Al with SQS structures. 
- Analyse embedding calculations to see how core structure changes with O content. 
